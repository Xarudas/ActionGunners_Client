...
{
    [CreateAssetMenu(fileName = "ConnectionSettings", menuName = "Installers/ConnectionSettings")]
    public class ConnectionSettings : ScriptableObjectInstaller<ConnectionSettings>
    {
        [SerializeField]
